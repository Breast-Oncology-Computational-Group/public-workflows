...
#
# ./inferCNV.R \
#     --raw_counts_matrix="../example/oligodendroglioma_expression_downsampled.counts.rds" \
#     --annotations_file="../example/oligodendroglioma_annotations_downsampled.csv" \
...
infercnv_obj <- infercnv::CreateInfercnvObject(raw_counts_matrix=raw_counts_matrix,
                                               ...
                                               annotations_file=annotations_file$cnv_celltype,
